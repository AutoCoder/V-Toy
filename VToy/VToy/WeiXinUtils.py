...
class WeiXinUtils:
    ...
    @staticmethod
    def DeviceInfo(devId="001",mac="123456789ABC",connect_protocol="4|1|2|3", auth_key='1234567890ABCDEF1234567890ABCDEF',close_strategy='1',conn_strategy='1',crypt_method='1', auth_ver='1',manu_mac_pos='-1',ser_mac_pos='-2'):
        """  DeviceInfo list   
        {
            "device_num":"2",
            "device_list":[
